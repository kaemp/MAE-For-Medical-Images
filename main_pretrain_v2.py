...
from engine_pretrain_v2 import train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/hpctmp/pbs_dm_stage/access_temp_stage/e1100476/Model/MAE/v2_.75',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/hpctmp/pbs_dm_stage/access_temp_stage/e1100476/Model/MAE/v2_.75',
...
def main(args):
    ...
    # define the model
    model = models_mae_v2.__dict__[args.model](norm_pix_loss=args.norm_pix_loss)
